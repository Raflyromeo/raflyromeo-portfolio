...
const SkillsSection = () => {
  const skills = [
    ...
    { name: "Graphic design", id: "Graphic design", top: 200, left: 150 },
    { name: "DATA SCIENCE", id: "data science", top: 10, left: 350 },
  ];
  ...
  return (
    <Card className="overflow-hidden text-left">
      <h1 className="mb-10 text-2xl font-semibold">Keterampilan</h1>
